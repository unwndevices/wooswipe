(function (document, window, $) {
    ...
    (function productThumbnails() {
        ...
        $(".thumbnail-nav").slick({
            ...
            slidesToScroll: 1,
            respondTo: "slider",
            prevArrow: '<button class="wooswipe-prev slick-arrow" aria-label="Previous" type="button"><img src="' + wooswipe_wp_plugin_path.templateUrl + '/public/images/arrow_left.svg" alt="Previous" /></button>',
            nextArrow: '<button class="wooswipe-next slick-arrow" aria-label="Next" type="button"><img src="' + wooswipe_wp_plugin_path.templateUrl + '/public/images/arrow_right.svg" alt="Next" /></button>',
            responsive: [
                {
                    breakpoint: 680,
                    settings: {
        ...
        var prevArrow  = '<button class="wooswipe-prev slick-arrow" aria-label="Previous" type="button"><img src="' + wooswipe_wp_plugin_path.templateUrl + '/public/images/arrow_left.svg" alt="Previous" /></button>';
        var nextArrow  = '<button class="wooswipe-next slick-arrow" aria-label="Next" type="button"><img src="' + wooswipe_wp_plugin_path.templateUrl + '/public/images/arrow_right.svg" alt="Next" /></button>';
